// Inline SVG icon set for the popup toolbar and settings help.
//
// Icons are from Lucide (https://lucide.dev), ISC License — no attribution
// required; this credit is a courtesy and documents provenance. Only the icons
// we use are copied here, so there is no runtime dependency, build step, or
// network call. Each is a complete <svg> string sized to 16px; stroke is
// currentColor so the buttons' existing color and dark-mode styling apply with
// no extra CSS.
...
export const ICONS = {
  ...
  'file-text': svg('<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>'),
  ...
  // Settings help
  'circle-help': svg('<circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>'),
